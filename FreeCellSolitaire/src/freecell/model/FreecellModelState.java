...
/**
 * This interface represents different operations that a freecell model must support
 * to return various aspects of its state. This interface does not provide
 * any operations to mutate the state of a freecell model.
 * @param <ICard> the Card type
 */
public interface FreecellModelState<ICard> {
   ...
   */
  int getNumCardsInFoundationPile(int index)
   ...
   * @throws IllegalStateException if the game has not started
   */
  int getNumCardsInCascadePile(int index)
      throws IllegalArgumentException,IllegalStateException;
   ...
   * @throws IllegalStateException if the game has not started
   */
  ICard getFoundationCardAt(int pileIndex,int cardIndex)
      throws IllegalArgumentException, IllegalStateException;
   ...
   * @throws IllegalStateException if the game has not started
   */
  ICard getCascadeCardAt(int pileIndex,int cardIndex)
      throws IllegalArgumentException, IllegalStateException;
   ...
   * @throws IllegalStateException if the game has not started
   */
  ICard getOpenCardAt(int pileIndex) throws IllegalArgumentException,IllegalStateException;
}
